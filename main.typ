...
#figure(
  ...
  image(
    ...
    width:50%,
    "bsuir_typst/examples/course_work/img/karjera.jpg"
  )
)
...
#figure(
  ...
  image(
    width:50%,
    "bsuir_typst/examples/course_work/img/einstein.jpg"
  )
) <einstein>
...
#figure(
  ...
  image(
    width:45%,
    "bsuir_typst/examples/course_work/img/kursach.jpg"
  )
) <kursach>
...
#stp2024.appendix(type:[обязательное], title:[#lorem(10)])[
  ...
  #figure(
    ...
    image(
      width:50%,
      "bsuir_typst/examples/course_work/img/podumat.jpg"
    )
  ) <kreslo>
